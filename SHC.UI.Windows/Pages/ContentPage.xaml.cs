...
{
    ContentPageViewModel viewModel;   
    public ContentPage()
    {
        InitializeComponent();
        viewModel = App.Services.GetRequiredService<ContentPageViewModel>();
    ...
    private void RegisterFrameAndPages()
    {
        ...
        NavigationService.RegisterFrame("ContentFrame", ContentFrame);
        NavigationService.RegisterPage(PageKey.RegisterPatient, "ContentFrame", typeof(RegisterPatientPage));
    }
}
